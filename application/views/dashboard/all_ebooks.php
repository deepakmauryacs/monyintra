            ...
            <div class="card">
               <div class="card-body">
                  <div class="head d-flex justify-content-between align-items-center mb-4">
                     <h4 class="card-title">E-books Enquiry</h4>
                  </div>
   ...
   $(document).ready(function(){
     ...
     function fill_datatable()
     {
      ...
      var dataTable = $('#datatable').DataTable({
       ...
       //         ],
       "ajax" : {
        url:"<?php echo base_url('Admin/Ebook/getEbookList');?>",
        type:"POST",
        data:{}
       }
      });
     ...
     $(document).on('click', '.delete', function(){  
              var ebook_id = $(this).attr("id");  
               ...
               if (result.value) {
                     $.ajax({
                        url:"<?php echo base_url(); ?>Admin/Ebook/delete_ebook",  
                        method:"POST",  
