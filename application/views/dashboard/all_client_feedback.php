            ...
            <div class="card">
               <div class="card-body">
                  <div class="head d-flex justify-content-between align-items-center mb-4">
                     <h4 class="card-title">All Clients Feedback List</h4>
                     <a  href="<?php  echo base_url('Admin/Feedback') ?>" style="border-radius: 0px;" class="btn btn-primary waves-effect waves-light">Add  Clients Feedback</a>
                  </div>
   ...
   $(document).ready(function(){
     ...
     function fill_datatable()
     {
      ...
      var dataTable = $('#datatable').DataTable({
       ...
       //         ],
       "ajax" : {
        url:"<?php echo base_url('Admin/Feedback/getFeedbacKList');?>",
        type:"POST",
        data:{}
       }
      });
