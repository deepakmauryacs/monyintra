            ...
            <div class="card">
               <div class="card-body">
                  <div class="head d-flex justify-content-between align-items-center mb-4">
                     ...
                     <a  href="<?php  echo base_url('Admin/Blog') ?>" style="border-radius: 0px;" class="btn btn-primary waves-effect waves-light">Add Blog</a>
                  </div>
   ...
   $(document).ready(function(){
     ...
     function fill_datatable()
     {
      ...
      var dataTable = $('#datatable').DataTable({
       ...
       //         ],
       "ajax" : {
        url:"<?php echo base_url('Admin/Blog/getBlogList');?>",
        type:"POST",
        data:{}
       }
      });
   ...
   function showDetails(id)
       {
         $.ajax({
                 type: "POST", 
                 url: '<?php echo base_url('Admin/Blog/showDetails');?>',
                 dataType:'html',
                 data:{'id':id}, 
                 beforeSend:function()
                 {},
