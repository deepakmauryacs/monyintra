                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Articles</h4>
                                         <a  href="<?php  echo base_url('Admin/Articles/all') ?>" style="border-radius: 0px;" class="btn btn-primary waves-effect waves-light">Go Back</a>
                                    </div>
                                    <hr>
...
$("#forms").submit(function(event) {
        ...
        $.ajax({
                type: "POST", 
                url: '<?php echo base_url('Admin/Articles/add');?>',
                dataType:'json',
                ...
                success:function(responce)
                {
                  ...
                  }else if(responce.status==1)
                  {
                    ...
                    window.location.href= '<?php echo base_url('Admin/Articles/all');?>';
