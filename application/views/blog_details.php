                        ...
                        <div class="col-xl-8 col-lg-8 mb-30">
                            <div class="blog-wrapper mb-60">
                                <div class="blog-img" style="height: 390px;">
                                    <img src="<?php echo base_url(); ?>uploads/blog/<?php echo $blog->image; ?>"  style="background-size:cover;" alt="">
                                </div>
                                <div class="blog-text blog-02-text">
                                    <div class="blog-meta">
                                        <span><i class="far fa-user"></i> <a href="#">Admin</a></span>
                                        <span><i class="far fa-calendar-alt"></i> <a href="blog-deatils.html"><?php echo  date("d-M-Y", strtotime($blog->created_at)) ?></a></span>
